            ...
            <div class="col-lg-12">
                <div class="cards cards-ds  shadow">
                    ...
                    <div class="body px-3 form-register">
                        <form action="../users/{$users.iduser}" method="POST">
                        
                            <div class="form-group">
                                <label for="username">Nome do Usuário:</label>
                                <input type="text" name="desperson" class="form-control"  value="{$users.desperson}" placeholder="Digite o nome" id="username">
                            </div>

                            <div class="form-group">
                              <label for="email">Endereço de e-mail:</label>
                              <input type="email" name="desemail" value="{$users.desemail}"  class="form-control" placeholder="Digite o email" id="email">
                            </div>

                            <div class="form-group">
                                <label for="number">Nº Telefone:</label>
                                <input type="number" name="nrphone" value="{$users.nrphone}"  class="form-control" placeholder="Digite o telefone" id="number">
                            </div>



                            <div class="ml-3 form-group form-check custom-control custom-switch">
                                <!--label class="form-check-label mr-5">
                                    <input class="form-check-input" type="checkbox" onclick="myFunction()"> Mostrar Senha
                                </label-->
                                <input type="checkbox" class="custom-control-input"  id="switch1"  name="inadmin" value="1" {if="$users.inadmin == 1"} checked {/if}>
