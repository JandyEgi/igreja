...
<body>
      ...
      <ul class="list-group mt-3 list-group-flush">
        ...
        <li class="list-group-item">
          ...
          <ul class="collapse show list-unstyled" data-parent="#sidebar-wrapper" id="layoutSubmenu">
            <li>
              <a href="../users/create" class="active"><i class="fa  fa-ellipsis-h "></i><span>Cadastrar Usuários</span></a>
            </li>
            <li>
                    ...
                    <div class="body px-3 form-register">
                        <form action="create" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="desperson" class="form-control" placeholder="Digite o nome" value="{$userValues.desperson}" id="username">
                            </div>
                            
                            <div class="form-group">
                              <label for="email">Endereço de e-mail:</label>
                              <input type="email" name="desemail" class="form-control" placeholder="Digite o email" id="email" value="{$userValues.desemail}">
                           </div>

                            <div class="form-group">
                                <label for="number">Nº Telefone:</label>
                                <input type="number" name="nrphone" class="form-control" placeholder="Digite o telefone" value="{$userValues.nrphone}" id="number">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="despassword" class="form-control" placeholder="Digite a senha" id="passwordCurrent" value="{$userValues.despassword}">
                            </div>

                            <div class="form-group">
                              <label for="pwd">Confirmar senha:</label>
                              <input type="password" name="despasswordConfirm" class="form-control" placeholder="Digite a senha" id="passwordConfirm" value="{$userValues.despasswordConfirm}">
                            </div>
                            ...
                            <div class="form-group form-check custom-control custom-switch">
                                ...
                                <input type="checkbox" class="custom-control-input"  id="switch1"  name="inadmin" value="1">
                                <label class="custom-control-label" for="switch1">Acesso de Administrador</label>
                            </div>
  ...
  <script type="text/javascript">
        ...
        function myFunction() {
            ...
            if (passwordConfirm.type === "password" || passwordCurrent.type === "password") {
                passwordConfirm.type = "text";
                passwordCurrent.type = "text";
            } else {
