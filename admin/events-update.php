  ...
  <div class="d-flex" id="wrapper">
    ...
    <aside class="bg-white border-right" id="sidebar-wrapper">
      ...
      <ul class="list-group mt-3 list-group-flush">
        ...
        <li class="list-group-item ">
          <a class="blue-text" href="#clientsSubmenu" data-toggle="collapse">
            <i class="fa fa-angle-down mr-2"></i>
            <i class="fa fa-users mr-1"></i>
            Clientes
          </a>

          <ul class="collapse show list-unstyled" data-parent="#sidebar-wrapper" id="clientsSubmenu">
            <li>
            ...
            <div class="col-lg-12">
                <div class="cards cards-ds  shadow">
                    ...
                    <div class="body px-3 form-register">
                        <form action="{$client.idclient}" method="POST" enctype="multipart/form-data">
                        
                            <div class="form-group">
                                <label for="desclient">Nome do Cliente:</label>
                                <input type="text" class="form-control" name="desclient" value="{$client.desclient}" placeholder="Digite o título" id="desclient">
                            </div>
                            
                            <div class="form-group">
                              <label for="file"> Fotos:</label>
                              <input type="file" id="file" name="desphoto" data-role="file" data-mode="drop">
                              <div class="images-file">
                                <img class="img-responsive" width="200" id="image-preview" src="{$client.desphotos}">
                              </div>
                            </div>
